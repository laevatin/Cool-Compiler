...
typedef AttrTable *AttrTableP;
typedef MethodTable *MethodTableP;
typedef SymbolTable<Symbol, Entry> TypeTable;
typedef TypeTable *TypeTableP;
...
public:
   ...
   virtual bool check_redefinition(Feature other, Class_ othercls, ClassTableP err_recorder) = 0;
...
public:
   ...
   virtual bool equal_type(Formal f) = 0;
...
public:
   ...
   // a little ugly
   bool check_redefinition(Feature other, Class_ othercls, ClassTableP err_recorder);
...
public:
   ...
   Symbol get_type_decl() { return type_decl; };
   Symbol get_name() { return name; };
   bool equal_type(Formal f) { return (dynamic_cast<formal_class *>(f))->type_decl == type_decl; }; 
...
public:
   ...
   Symbol get_name() { return name; };
   Symbol get_type_decl() { return type_decl; };
   Symbol eval_type(TypeTableP symtbl, Class_ cls, MethodTableP methodtable, 
